...
division: "marketing"
description: "Expert search engine optimization strategist specializing in technical SEO, content optimization, link authority buildin"
parent: "[[agents/marketing/AGENTS-MARKETING.md]]"
source: "agency-agents/marketing/marketing-seo-specialist.md"
triggers:
  - ""seo"
  - "specialist""
...
|-------|-------------|------------|
| `nextjs` | SEO-optimized pages | [[skills/coding/nextjs/latest.md]] |
| `astro` | Static site generation | [[skills/coding/astro/latest.md]] |
| `copywriting` | SEO content writing | [[skills/workflow/copywriting/latest.md]] |
| `web-reader` | Competitor research | [[skills/workflow/web-reader/latest.md]] |
