...
division: "marketing"
description: "Expert content strategist and creator for multi-platform campaigns. Develops editorial calendars, creates compelling cop"
parent: "[[agents/marketing/AGENTS-MARKETING.md]]"
source: "agency-agents/marketing/marketing-content-creator.md"
triggers:
  - ""content"
  - "creator""
...
|-------|-------------|------------|
| `copywriting` | Content frameworks | [[skills/workflow/copywriting/latest.md]] |
| `web-reader` | Research and ideation | [[skills/workflow/web-reader/latest.md]] |
