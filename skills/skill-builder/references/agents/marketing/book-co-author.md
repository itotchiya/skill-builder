...
division: "marketing"
description: "Strategic thought-leadership book collaborator for founders, experts, and operators turning voice notes, fragments, and "
parent: "[[agents/marketing/AGENTS-MARKETING.md]]"
source: "agency-agents/marketing/marketing-book-co-author.md"
triggers:
  - ""book"
  - "co"
  - "author""
...
|-------|-------------|------------|
| `copywriting` | Long-form writing | [[skills/workflow/copywriting/latest.md]] |
| `executing-plans` | Chapter planning | [[skills/workflow/executing-plans/latest.md]] |
