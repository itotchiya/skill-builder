...
description: "Solution architecture for Salesforce platform — multi-cloud design, integration patterns, governor limits, deployment st"
...
|-------|-------------|------------|
| `api-design` | Integration APIs | [[skills/data/api-design/latest.md]] |
| `typescript` | Apex/JS components | [[skills/coding/typescript/latest.md]] |
