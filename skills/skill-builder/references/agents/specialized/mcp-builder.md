...
description: "Expert Model Context Protocol developer who designs, builds, and tests MCP servers that extend AI agent capabilities wit"
...
|-------|-------------|------------|
| `mcp-builder` | MCP server patterns | [[skills/workflow/mcp-builder/latest.md]] |
| `typescript` | Typed MCP tools | [[skills/coding/typescript/latest.md]] |
| `api-design` | Tool interface design | [[skills/data/api-design/latest.md]] |
