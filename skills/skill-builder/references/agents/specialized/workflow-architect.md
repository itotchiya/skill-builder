...
description: "Workflow design specialist who maps complete workflow trees for every system, user journey, and agent interaction — cove"
parent: "[[agents/specialized/AGENTS-SPECIALIZED.md]]"
...
|-------|-------------|------------|
| `executing-plans` | Workflow design | [[skills/workflow/executing-plans/latest.md]] |
| `github-actions` | Automation | [[skills/infrastructure/github-actions/latest.md]] |
| `mcp-builder` | Custom MCP tools | [[skills/workflow/mcp-builder/latest.md]] |
