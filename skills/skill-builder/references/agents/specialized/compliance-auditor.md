...
description: "Expert technical compliance auditor specializing in SOC 2, ISO 27001, HIPAA, and PCI-DSS audits — from readiness assessm"
...
|-------|-------------|------------|
| `secrets` | Secrets compliance | [[skills/security/secrets/latest.md]] |
| `github-actions` | Audit automation | [[skills/infrastructure/github-actions/latest.md]] |
