...
description: "Governance-first architect for business automations (n8n-first) who audits value, risk, and maintainability before imple"
...
|-------|-------------|------------|
| `executing-plans` | Governance frameworks | [[skills/workflow/executing-plans/latest.md]] |
| `github-actions` | Automated controls | [[skills/infrastructure/github-actions/latest.md]] |
