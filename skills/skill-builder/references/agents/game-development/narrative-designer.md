...
description: "Story systems and dialogue architect - Masters GDD-aligned narrative design, branching dialogue, lore architecture, and "
parent: "[[agents/game-development/AGENTS-GAME_DEVELOPMENT.md]]"
...
|-------|-------------|------------|
| `copywriting` | Story writing | [[skills/workflow/copywriting/latest.md]] |
| `executing-plans` | Narrative planning | [[skills/workflow/executing-plans/latest.md]] |
