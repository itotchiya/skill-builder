...
title: "UX Researcher"
division: "design"
description: "Expert user experience researcher specializing in user behavior analysis, usability testing, and data-driven design insi"
parent: "[[agents/design/AGENTS-DESIGN.md]]"
source: "agency-agents/design/design-ux-researcher.md"
triggers:
  - ""ux"
  - "researcher""
...
|-------|-------------|------------|
| `ui-ux` | Research principles | [[skills/design/ui-ux/latest.md]] |
| `executing-plans` | Research plans | [[skills/workflow/executing-plans/latest.md]] |
