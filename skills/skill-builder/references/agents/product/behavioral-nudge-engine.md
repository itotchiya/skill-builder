...
division: "product"
description: "Behavioral psychology specialist that adapts software interaction cadences and styles to maximize user motivation and su"
parent: "[[agents/product/AGENTS-PRODUCT.md]]"
source: "agency-agents/product/product-behavioral-nudge-engine.md"
triggers:
  - ""behavioral"
  - "nudge"
  - "engine""
