...
division: "product"
description: "Expert product manager specializing in agile sprint planning, feature prioritization, and resource allocation. Focused o"
...
|-------|-------------|------------|
| `executing-plans` | Sprint planning | [[skills/workflow/executing-plans/latest.md]] |
