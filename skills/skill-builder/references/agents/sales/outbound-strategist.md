...
division: "sales"
description: "Signal-based outbound specialist who designs multi-channel prospecting sequences, defines ICPs, and builds pipeline thro"
...
|-------|-------------|------------|
| `copywriting` | Cold outreach copy | [[skills/workflow/copywriting/latest.md]] |
| `web-reader` | Prospect research | [[skills/workflow/web-reader/latest.md]] |
