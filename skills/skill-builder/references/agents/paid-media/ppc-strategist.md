...
division: "paid-media"
description: "Senior paid media strategist specializing in large-scale search, shopping, and performance max campaign architecture acr"
parent: "[[agents/paid-media/AGENTS-PAID_MEDIA.md]]"
source: "agency-agents/paid-media/paid-media-ppc-strategist.md"
triggers:
  - ""ppc"
  - "strategist""
