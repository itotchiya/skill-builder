...
description: "Expert project manager specializing in cross-functional project coordination, timeline management, and stakeholder align"
parent: "[[agents/project-management/AGENTS-PROJECT_MANAGEMENT.md]]"
...
|-------|-------------|------------|
| `executing-plans` | Execution methodology | [[skills/workflow/executing-plans/latest.md]] |
| `find-skills` | Resource discovery | [[skills/workflow/find-skills/latest.md]] |
| `github-actions` | Automated workflows | [[skills/infrastructure/github-actions/latest.md]] |
