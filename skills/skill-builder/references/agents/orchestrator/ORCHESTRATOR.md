...
parent: "[[agents/orchestrator/AGENTS-ORCHESTRATOR.md]]"
source: "agency-agents/orchestrator/agents-orchestrator.md"
triggers:
  - ""agents"
  - "orchestrator""
...
|-------|-------------|------------|
| `executing-plans` | Pipeline execution | [[skills/workflow/executing-plans/latest.md]] |
| `find-skills` | Agent discovery | [[skills/workflow/find-skills/latest.md]] |
| `mcp-builder` | Tool coordination | [[skills/workflow/mcp-builder/latest.md]] |
