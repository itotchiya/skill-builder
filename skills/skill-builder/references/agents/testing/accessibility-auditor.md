...
division: "testing"
description: "Expert accessibility specialist who audits interfaces against WCAG standards, tests with assistive technologies, and ens"
parent: "[[agents/testing/AGENTS-TESTING.md]]"
source: "agency-agents/testing/testing-accessibility-auditor.md"
triggers:
  - ""accessibility"
  - "auditor""
...
|-------|-------------|------------|
| `playwright` | Automated a11y tests | [[skills/tools/playwright/latest.md]] |
| `react` | Accessible components | [[skills/coding/react/latest.md]] |
| `tailwindcss` | Contrast utilities | [[skills/coding/tailwindcss/latest.md]] |
