...
division: "testing"
description: "Expert process improvement specialist focused on analyzing, optimizing, and automating workflows across all business fun"
...
|-------|-------------|------------|
| `executing-plans` | Process planning | [[skills/workflow/executing-plans/latest.md]] |
