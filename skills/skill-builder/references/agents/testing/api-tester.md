...
title: "API Tester"
division: "testing"
description: "Expert API testing specialist focused on comprehensive API validation, performance testing, and quality assurance across"
...
|-------|-------------|------------|
| `api-design` | API contract testing | [[skills/data/api-design/latest.md]] |
| `vitest` | Unit/integration tests | [[skills/tools/vitest/latest.md]] |
| `playwright` | E2E testing | [[skills/tools/playwright/latest.md]] |
| `zod` | Schema validation | [[skills/coding/zod/latest.md]] |
