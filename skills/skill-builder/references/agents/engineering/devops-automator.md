...
|-------|-------------|------------|
| `docker` | Container builds | [[skills/infrastructure/docker/latest.md]] |
| `docker-compose` | Local orchestration | [[skills/infrastructure/docker-compose/latest.md]] |
| `github-actions` | CI/CD automation | [[skills/infrastructure/github-actions/latest.md]] |
| `vercel` | Frontend deployment | [[skills/infrastructure/vercel/latest.md]] |
| `kubernetes` | Container orchestration | [[skills/infrastructure/kubernetes/latest.md]] |
| `terraform` | Infrastructure as code | [[skills/infrastructure/terraform/latest.md]] |
| `nginx` | Reverse proxy & routing | [[skills/infrastructure/nginx/latest.md]] |
