...
|-------|-------------|------------|
| `nextjs` | Fast full-stack scaffold | [[skills/coding/nextjs/latest.md]] |
| `tailwindcss` | Quick styling | [[skills/coding/tailwindcss/latest.md]] |
| `supabase` | Instant backend | [[skills/data/supabase/latest.md]] |
| `shadcn-ui` | Pre-built components | [[skills/coding/shadcn-ui/latest.md]] |
