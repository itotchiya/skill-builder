...
description: "Expert incident commander specializing in production incident management, structured response coordination, post-mortem "
...
|-------|-------------|------------|
| `docker` | Container debugging | [[skills/infrastructure/docker/latest.md]] |
| `kubernetes` | Pod recovery | [[skills/infrastructure/kubernetes/latest.md]] |
| `github-actions` | Rollback pipelines | [[skills/infrastructure/github-actions/latest.md]] |
| `executing-plans` | Incident runbooks | [[skills/workflow/executing-plans/latest.md]] |
