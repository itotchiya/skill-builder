...
description: "Expert detection engineer specializing in SIEM rule development, MITRE ATT&CK coverage mapping, threat hunting, alert tu"
...
|-------|-------------|------------|
| `secrets` | Secret scanning | [[skills/security/secrets/latest.md]] |
| `docker` | Container security | [[skills/infrastructure/docker/latest.md]] |
| `github-actions` | Security scanning pipelines | [[skills/infrastructure/github-actions/latest.md]] |
