...
description: "Expert data engineer specializing in building reliable data pipelines, lakehouse architectures, and scalable data infras"
...
|-------|-------------|------------|
| `postgresql` | Relational data | [[skills/data/postgresql/latest.md]] |
| `mongodb` | Document storage | [[skills/data/mongodb/latest.md]] |
| `redis` | In-memory caching/queues | [[skills/data/redis/latest.md]] |
| `prisma` | Schema management | [[skills/data/prisma/latest.md]] |
| `drizzle` | TypeScript ORM | [[skills/data/drizzle/latest.md]] |
| `docker` | Data pipeline containers | [[skills/infrastructure/docker/latest.md]] |
