...
description: "Expert database specialist focusing on schema design, query optimization, indexing strategies, and performance tuning fo"
...
|-------|-------------|------------|
| `postgresql` | Query optimization | [[skills/data/postgresql/latest.md]] |
| `prisma` | ORM performance | [[skills/data/prisma/latest.md]] |
| `drizzle` | TypeScript queries | [[skills/data/drizzle/latest.md]] |
| `redis` | Caching layer | [[skills/data/redis/latest.md]] |
| `mongodb` | NoSQL tuning | [[skills/data/mongodb/latest.md]] |
