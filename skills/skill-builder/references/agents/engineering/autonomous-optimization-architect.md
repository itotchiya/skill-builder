...
description: "Intelligent system governor that continuously shadow-tests APIs for performance while enforcing strict financial and sec"
parent: "[[agents/engineering/AGENTS-ENGINEERING.md]]"
source: "agency-agents/engineering/engineering-autonomous-optimization-architect.md"
triggers:
  - ""autonomous"
  - "optimization"
  - "architect""
...
|-------|-------------|------------|
| `typescript` | Type-safe optimization | [[skills/coding/typescript/latest.md]] |
| `postgresql` | DB performance | [[skills/data/postgresql/latest.md]] |
| `redis` | Cache optimization | [[skills/data/redis/latest.md]] |
