...
description: "Expert application security engineer specializing in threat modeling, vulnerability assessment, secure code review, and "
...
|-------|-------------|------------|
| `secrets` | Environment & secret management | [[skills/security/secrets/latest.md]] |
| `t3-env` | Type-safe env vars | [[skills/security/t3-env/latest.md]] |
| `authjs` | Authentication | [[skills/coding/authjs/latest.md]] |
| `zod` | Input validation | [[skills/coding/zod/latest.md]] |
